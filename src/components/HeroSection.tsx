...
export const HeroSection = () => {
  return (
    <section className="relative min-h-[70vh] overflow-hidden bg-card">
      ...
      <div className="relative container mx-auto px-6 lg:px-12 h-full min-h-[70vh] flex items-center justify-center text-center">
        <div className="max-w-2xl py-20">
          <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-light tracking-wide text-white mb-4 animate-fade-in">
            Khaleesi Fragrances
          </h1>
          <p className="font-body text-sm md:text-base tracking-[0.25em] uppercase text-white/80 mb-10 animate-fade-in" style={{ animationDelay: "0.15s" }}>
